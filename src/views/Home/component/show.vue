...
export default {
  data() {
    return {
      product: {
        image: 'https://th.bing.com/th/id/OIP.Uxeab6awUab9fgxYihQ-AwHaE4?rs=1&pid=ImgDetMain',
        name: '商品A',
        price: 100,
...
<template>
  <div class="purchase-product">
    <!-- 商品信息展示,这个地方完全是要用接口来的因为商品不能够写死 -->
    <div class="product-info">
      <el-image :src="product.image" fit="cover" style="width: 100%; height: 200px"></el-image>
    ...
    <!-- 购买信息输入对话框 -->
    <el-dialog title="填写购买信息" v-model="purchaseDialogVisible" width="30%">
