  ...
  data() {
    return {
      product: {
        ...
        images: ['https://img.alicdn.com/imgextra/i4/2217113064277/O1CN01b0laEU1hSuxJJsUFR_!!2217113064277.jpg','https://img.alicdn.com/imgextra/i1/2217113064277/O1CN01gmh6111hSuxHrfdnh_!!2217113064277.jpg'],
        name: 'Kappa女鞋德训鞋',
        price: 359.9,
...
<template>
  <div class="progress-bar" v-if="currentStep > 0">
    <el-steps :active="currentStep" finish-status="success">
      <el-step title="Submit Purchase Information"></el-step>
      <el-step title="Item Frozen"></el-step>
      <el-step title="Item Sold"></el-step>
    </el-steps>
  </div>
